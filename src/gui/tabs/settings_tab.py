...
class SettingsTab(customtkinter.CTkFrame):
    ...
    def setup_api_settings(self):
        ...
        self.openai_key.grid(row=4, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.show_api_key.grid(row=4, column=2, padx=5, pady=5)
    ...
    def setup_email_settings(self):
        ...
        label.grid(row=5, column=0, columnspan=2, sticky="w", padx=10, pady=(20, 10))
        ...
        self.smtp_server.grid(row=6, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.smtp_port.grid(row=7, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.email_from.grid(row=8, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.email_to.grid(row=9, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.smtp_username.grid(row=10, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.smtp_password.grid(row=11, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.show_smtp_pass.grid(row=11, column=2, padx=5, pady=5)
    ...
    def setup_model_settings(self):
        ...
        label.grid(row=12, column=0, columnspan=2, sticky="w", padx=10, pady=(20, 10))
        ...
        self.writer_model.grid(row=13, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.judge_model.grid(row=14, column=1, sticky="ew", padx=10, pady=5)
        self.judge_model.insert(0, self.config.get("JUDGE_MODEL", ""))
        
        # # Agent Model
        # customtkinter.CTkLabel(self.scrollable_frame, text="Agent Model:").grid(
        #     row=14, column=0, sticky="w", padx=10, pady=5
        # )
        # self.agent_model = customtkinter.CTkEntry(self.scrollable_frame, width=400)
        # self.agent_model.grid(row=14, column=1, sticky="ew", padx=10, pady=5)
    ...
    def setup_gist_settings(self):
        ...
        label.grid(row=15, column=0, columnspan=2, sticky="w", padx=10, pady=(20, 10))

        # GIST ID
        customtkinter.CTkLabel(self.scrollable_frame, text="GIST ID:").grid(
            row=16, column=0, sticky="w", padx=10, pady=5
        )
        self.gist_id = customtkinter.CTkEntry(self.scrollable_frame, width=400)
        self.gist_id.grid(row=16, column=1, sticky="ew", padx=10, pady=5)
        ...
        self.github_token.grid(row=17, column=1, sticky="ew", padx=10, pady=5)
    ...
    def setup_save_button(self):
        ...
        self.save_button.grid(row=18, column=0, columnspan=2, pady=20)
